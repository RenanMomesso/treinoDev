...
export default (props) => {
    ...
    const handleScrollEnd = (e) => {
        ...
        let targetMonth = Math.round(posX/widthM);
...
snapToInterval={widthM}
contentContainerStyle={{paddingLeft:widthM, paddingRight:widthM}}
onMomentumScrollEnd={handleScrollEnd}

>
    {months.map((m, k)=>(
        <MonthButton key={k} width={widthM} onPress={()=>setSelectedMonth(k)} underlayColor="transparent">
