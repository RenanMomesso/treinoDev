    ...
    return (
        <Container>
            ...
            <HomeDayStatus
             ...
             goToWorkout={()=>props.navigation.navigate('MyWorkoutStack')}
            ...
            <LegendText>Legenda: </LegendText>
                ...
                <LegendItem>
                    <LegendBox style={{backgroundColor:'#F4F4F4', opacity:0.2, borderWidth:1, borderColor:'black'}}></LegendBox>
                    <LegendText>Dia de descanso </LegendText>
                </LegendItem>
                <LegendItem>
                    <LegendBox style={{backgroundColor:'#B3B3B3'}}></LegendBox>
